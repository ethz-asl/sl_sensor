...
#ifndef SL_SENSOR_REGISTRATION_LIBPOINTMATCHER_ICP_HPP_
#define SL_SENSOR_REGISTRATION_LIBPOINTMATCHER_ICP_HPP_
...
#endif  // SL_SENSOR_REGISTRATION_LIBPOINTMATCHER_ICP_HPP_