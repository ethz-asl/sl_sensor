 ...
 * @param number_cameras - Optional field if number of cameras need to be specified for downstream processes
 * @param id - Optional field if string information (.e.g. projector pattern name) needs to be specified for downstream
 * processes
 */
...
void PublishCvMatVec(ros::Publisher& publisher, const std::vector<cv::Mat>& cv_mat_vec, const std::string& frame_id,
                     ...
                     const std::vector<std::string>& encodings_vec, int number_cameras = 1, const std::string& id = "");
 ...
 * @param id - String information (.e.g. projector pattern name) needs to be specified for downstream
 */
